...
class SpeedOverGroundGeneratorTest {
  ...
  void testGenerateSpeedOverGround() {
    ...
    SpeedGeneratorConfigDTO vo = new SpeedGeneratorConfigDTO(speedRangeMinValue, speedRangeMaxValue,
        20);
  ...
  void shouldGenerateSOGWhenLastSOGisNull() {
    //given
    SpeedGeneratorConfigDTO vo = new SpeedGeneratorConfigDTO(0, 20, 10);
  ...
  void shouldThrowExceptionWhenSpeedGeneratorConfigVOisNull() {
    //given
    SpeedGeneratorConfigDTO vo = null;
    //when
    //then
